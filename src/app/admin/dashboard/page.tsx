      ...
      <main className="flex-1 overflow-y-auto p-8 font-sans">
        <div className="flex justify-between items-center mb-8 border-b border-[var(--color-ivory-200)] pb-4">
          ...
          <div className="flex gap-2">
            ...
            <Link href="/admin/dashboard?filter=all" className={`px-4 py-2 rounded text-sm ${filter === 'all' ? 'bg-[var(--color-forest-900)] text-white' : 'bg-white border text-zinc-600'}`}>الكل</Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-[var(--color-ivory-200)]">
            ...
            <p className="text-3xl font-bold text-[var(--color-forest-900)]">{totalSales.length}</p>
          </div>

          <div className="bg-white p-6 rounded-xl shadow-sm border border-[var(--color-ivory-200)] flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-[var(--color-forest-900)] mb-1">المنتجات منخفضة المخزون</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-[var(--color-ivory-200)]">
            <h2 className="text-xl font-bold text-[var(--color-forest-900)] mb-4">المنتجات الناقصة</h2>
