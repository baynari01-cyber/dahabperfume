                ...
                {products.length === 0 && (
                  <tr>
                    <td colSpan={8} className="px-6 py-16 text-center">
                      ...
                      <Link href="/admin/products/new" className="inline-flex bg-[var(--color-forest-900)] text-white px-6 py-2 rounded font-bold text-sm hover:bg-[var(--color-forest-800)] transition-colors">
                        + إضافة أول عطر
                      </Link>
                    </td>
                  </tr>
