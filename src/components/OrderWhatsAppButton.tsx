...
export function OrderWhatsAppButton({ 
  ...
  return (
    <button 
      ...
      className="w-full mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg shadow-md transition-all active:scale-95 text-sm"
    >
      ...
      إرسال فاتورة وتأكيد عبر واتساب
    </button>
  );
}
